...
## 🛠 Prerequisites (From Challenge Image)
- **Python 3.10+**: The simulation logic follows the OpenEnv Python core specifications.
- **Docker**: Containerized for isolated testing and deployment.
- **Git/GitHub**: Ready for repository push.
- **Hugging Face**: Optimized for deployment to HF Spaces.
...
### 2. Hugging Face Spaces (HF CLI)
1. Install CLI: `pip install huggingface_hub`
2. Login: `huggingface-cli login`
3. Create a new Space (Static or Docker).
...
docker run -p 3000:3000 openenv-app
```
